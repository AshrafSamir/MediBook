...
const {signup,createUser,getAllUsers, getUserByid, getAllDoctors, getAllAdmins, getAllClients, deleteUser, updateUser} = require('../controllers/signup.controller')
...
signupRoute.patch('/updateuser/:id',userImage.single("profileImage"),updateUser);
